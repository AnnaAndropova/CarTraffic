...
@Configuration
@ComponentScan(basePackageClasses = {CarComponent.class, DumbConfig.class, Car.class, CarRepository.class, CarRepositoryImpl.class, CarGenerationService.class, CarRowMapper.class})
//@PropertySource("classpath:traffic.properties")
public class JdbcApp {


    public static void main(String[] args) throws Exception {
        ApplicationContext context = new AnnotationConfigApplicationContext(JdbcApp.class);
